    ...
    >
      <div className="flex gap-2 sm:gap-3">
            <textarea
              ...
              rows={2}
              maxLength={1000}
              className="flex-1 px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 dark:focus:ring-gray-500 focus:border-gray-400 dark:focus:border-gray-500 disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:cursor-not-allowed disabled:text-gray-400 dark:disabled:text-gray-500 resize-none text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 font-light text-sm sm:text-base bg-white dark:bg-gray-800 transition-colors"
            ...
            <button
              ...
              className="px-4 py-2.5 sm:px-6 sm:py-3 bg-gray-900 dark:bg-gray-700 text-white rounded-lg hover:bg-gray-800 dark:hover:bg-gray-600 active:scale-95 disabled:bg-gray-200 dark:disabled:bg-gray-800 disabled:text-gray-400 dark:disabled:text-gray-500 disabled:cursor-not-allowed transition-all whitespace-nowrap font-medium text-sm sm:text-base min-h-[44px] touch-device:min-h-[48px]"
