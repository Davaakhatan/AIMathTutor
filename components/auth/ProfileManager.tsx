...
export default function ProfileManager() {
  ...
  // For students: Show their own profile management (simplified - only profile, link code, and access)
  return (
    <div className="space-y-4 pb-2 max-h-[700px] overflow-y-auto p-4">
      {/* Header */}
      <div className="text-center mb-4">
        <h2 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent mb-1">
          My Profile
        </h2>
      ...
      {studentProfile && (
        <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-lg bg-gray-900 dark:bg-gray-700 flex items-center justify-center text-white text-base font-bold">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 rounded text-xs font-medium">
                  {studentProfile.difficulty_preference}
                </span>
              </div>
            </div>
            <button
              onClick={() => handleEdit(studentProfile)}
      ...
      {/* No profile message */}
      {!studentProfile && !editingProfile && profilesLoading && (
