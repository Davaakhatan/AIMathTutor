      ...
      <div className="flex items-center justify-between">
        ...
        {!showCreateForm && (
          <button
            ...
            className="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors flex items-center gap-1.5"
          >
