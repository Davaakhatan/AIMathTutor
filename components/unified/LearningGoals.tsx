      ...
      <div className="flex items-center justify-between">
        ...
        {!showCreateForm && (
          <button
            ...
            className="px-3 py-1.5 bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors text-xs font-medium"
          >
            + New Goal
          </button>
        )}
