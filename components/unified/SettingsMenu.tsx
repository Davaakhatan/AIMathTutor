...
export default function SettingsMenu({ onXPDataChange }: SettingsMenuProps) {
  ...
  return (
    ...
    >
      ...
      {/* Tab Content */}
      <div className="flex-1 overflow-y-auto min-h-0 overscroll-contain scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent" style={{ maxHeight: 'calc(85vh - 80px)' }}>
